            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow d-sm-flex p-3 justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Perdata Permohonan - Tulis Perkara</h1>
                    </div>
                            ...
                            <div class="card shadow px-3 py-2">
                                <form action="{{ route('permohonan.store') }}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kuasahukum_pemohon" name="kuasahukum_pemohon" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="termohon" class="text-gray-900">Termohon</label>
                                        <input type="text" class="form-control" id="termohon" name="termohon" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="kuasahukum_termohon" class="text-gray-900">Kuasa Hukum Termohon</label>
                                        <input type="text" class="form-control" id="kuasahukum_termohon" name="kuasahukum_termohon" required>
                                    </div>
                                    <div class="form-group mb-3">
