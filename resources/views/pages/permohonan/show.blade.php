            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow d-sm-flex p-3 justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Perdata Permohonan - Details</h1>
                    </div>
                        ...
                        <table class="table table-bordered bg-white">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>{{ Str::ucfirst($data->pemohon) }}</td>
                              <td>{{ Str::ucfirst($data->termohon) }}</td>
                    ...
                    <div class="row">
                      <div class="col-lg-12 mb-4">
                        <table class="table table-bordered bg-white">
                          ...
                          <tr>
                            <td style="width: 250px; background-color: #b8791a;" class="text-white">Pemohon</td>
                            <td>{{ Str::ucfirst($data->pemohon) }}</td>
                          </tr>
                          <tr>
                            <td style="width: 250px; background-color: #b8791a;" class="text-white">Kuasa Pemohon</td>
                            <td>{{ Str::ucfirst($data->kuasahukum_pemohon) }}</td>
                          </tr>
                          <tr>
                            <td style="width: 250px; background-color: #b8791a;" class="text-white">Termohon</td>
                            <td>{{ Str::ucfirst($data->termohon) }}</td>
                          </tr>
                          <tr>
                            <td style="width: 250px; background-color: #b8791a;" class="text-white">Kuasa Hukum Termohon</td>
                            <td>{{ Str::ucfirst($data->kuasahukum_termohon) }}</td>
                          </tr>
                        </table>
                      </div>
                    </div>
