            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow d-sm-flex p-3 justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Perdata Permohonan</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center mb-1">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pbs }}</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="d-flex justify-content-between">
                                        <h6 style="color: #b8791a;" class="m-0 font-weight-bold">Data Perkara Permohonan
                                            - Belum Selesai</h6>
                                        ...
                                        <table class="table table-hover" id="TABLE_1" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>Pemohon : {{ Str::ucfirst($d->pemohon) }}</p>
                                                        <p>Termohon : {{ Str::ucfirst($d->termohon) }}</p>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-sm btn-warning">Belum Selesai</a>
                                                    </td>
                                                    <td>{{ $d->lama_proses }}</td>
                                                    <td>
                                                        <form action="{{ route('permohonan.destroy', $d->id) }}" method="post">
                                                            <a target="_blank" href="{{ route('permohonan.show', $d->id) }}" class="btn btn-md btn-secondary">
                                                                <i class="fa-solid fa-eye"></i>
                                                            </a>
                                                            <a target="_blank" href="{{ route('permohonan.edit', $d->id) }}" class="btn btn-md btn-primary">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            <a class="btn btn-sm btn-secondary d-block" target="_blank" href="{{ route('permohonan.create') }}">Tulis Perkara</a>
                        </div>
                    </div>
